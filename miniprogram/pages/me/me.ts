...
import { setThemeMode,syncTheme,themeState,ThemeMode } from '../../utils/theme';
...
Page({
 ...
 theme(event:WechatMiniprogram.BaseEvent){const mode=event.currentTarget.dataset.mode as ThemeMode;setThemeMode(mode);},
