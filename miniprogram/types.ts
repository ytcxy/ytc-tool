...
export interface Sentence {id:DatabaseId;audioUrl?:string|null;sequence:number;speaker:0|1;speakerName?:string;zh:string;en:string;context:string;status:Status;revealed:boolean;episodeId?:DatabaseId;episodeTitle?:string;episodeSequence?:number;collectionTitle?:string}
