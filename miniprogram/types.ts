...
export interface Sentence {id:DatabaseId;sequence:number;zh:string;en:string;context:string;status:Status;revealed:boolean;episodeId?:DatabaseId;episodeTitle?:string;episodeSequence?:number;collectionTitle?:string}
